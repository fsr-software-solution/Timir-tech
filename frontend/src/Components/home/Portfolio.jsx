    ...
    const projects = [
        {
            ...
            githubUrl: "https://github.com/timir-tech/frelancer-hub"
        },
        {
            id: 2,
        ...
        <section className="py-16 md:py-32 bg-surface-container-low" id="portfolio">
            <div className="max-w-7xl mx-auto px-8">
                <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
                    <div>
                        <h3 className="headline text-2xl md:text-3xl font-bold mb-4">Our Artifacts</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    {projects.slice(0, visibleCount).map((project, index) => (
                        <div
                            key={project.id}
                            className={`group relative overflow-hidden rounded-[3rem] aspect-[4/3] glass-card ${index % 2 === 1 ? 'md:mt-12' : ''}`}
                        >
                            <img
                ...
                {visibleCount < projects.length && (
                    <div className="flex justify-center mt-20">
                        <button
                            onClick={showMore}
                            className="group relative px-12 py-4 rounded-full bg-primary text-on-primary font-bold text-lg hover:shadow-[0_0_30px_rgba(var(--primary-rgb),0.4)] transition-all duration-300"
                        >
