            ...
            <section className="py-20 md:py-32 bg-surface-container-low border-b border-white/5 relative">
                ...
                <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
                    <div className="text-center mb-20">
                        ...
                        <p className="text-on-surface-variant max-w-3xl mx-auto text-lg leading-relaxed">We understand that a TikTok, Instagram, YouTube, LinkedIn and other reels require vastly different pacing than a corporate documentary. Our editors specialize in platform-specific narrative structures.</p>
                    </div>
