    ...
    return (
        <div className="min-h-screen bg-slate-950 text-slate-300 font-['Manrope'] selection:bg-amber-500/30 mt-16 py-16">
            <div className="max-w-4xl mx-auto px-5 sm:px-8 relative">
                ...
                <h1 className="text-4xl md:text-5xl font-black text-white mb-6">Privacy <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-amber-600">Policy</span></h1>
